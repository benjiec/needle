...
class TestRefiningHitsWithHMM(unittest.TestCase):
    ...
    def test_find_matches_at_locus_incrementally_search_for_more_matches(self):
        ...
        def fake_hmmsearch_to_dna_coords(_, translations):
            first_match = [
                dict(target_name="cand_0", score=100, evalue=0.1, hmm_from=5, hmm_to=10, target_from=10001, target_to=10018),
                dict(target_name="cand_1", score=100, evalue=0.2, hmm_from=9, hmm_to=15, target_from=11021, target_to=11041),
                dict(target_name="cand_2", score=100, evalue=0.3, hmm_from=16, hmm_to=20, target_from=11051, target_to=11065)
            ]
            second_match = [
                # add a new match
                dict(target_name="cand_0", score=100, evalue=0.1, hmm_from=1, hmm_to=4, target_from=9001, target_to=9012),
                dict(target_name="cand_0", score=100, evalue=0.1, hmm_from=5, hmm_to=10, target_from=10001, target_to=10018),
                dict(target_name="cand_1", score=100, evalue=0.2, hmm_from=9, hmm_to=15, target_from=11021, target_to=11041),
                dict(target_name="cand_2", score=100, evalue=0.3, hmm_from=16, hmm_to=20, target_from=11051, target_to=11065)
            ]
    ...
    def test_find_matches_at_locus_stops_searching_if_found_nonlinear_overlap(self):
        ...
        def fake_hmmsearch_to_dna_coords(_, translations):
            first_match = [
                dict(target_name="cand_0", score=100, evalue=0.1, hmm_from=5, hmm_to=10, target_from=10018, target_to=10001),
                dict(target_name="cand_1", score=100, evalue=0.2, hmm_from=9, hmm_to=15, target_from=11041, target_to=11021),
                dict(target_name="cand_2", score=100, evalue=0.3, hmm_from=16, hmm_to=20, target_from=11065, target_to=11051)
            ]

            second_match = [
                dict(target_name="cand_0", score=100, evalue=0.1, hmm_from=1, hmm_to=11, target_from=8550, target_to=8518),
                dict(target_name="cand_0", score=100, evalue=0.1, hmm_from=5, hmm_to=10, target_from=10018, target_to=10001),
                dict(target_name="cand_1", score=100, evalue=0.2, hmm_from=9, hmm_to=15, target_from=11041, target_to=11021),
                dict(target_name="cand_2", score=100, evalue=0.3, hmm_from=16, hmm_to=20, target_from=11065, target_to=11051)
            ]
